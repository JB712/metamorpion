...
public class Console extends Thread {
	...
	public void afficherFinPartie(Partie partie) {
		...
		System.out.println("Joueur 1 :" + partie.getJ1().getNom()+" : "+timeToString(partie.getTempsReflexionJ1())+"s");
		System.out.println("Joueur 2 :" + partie.getJ2().getNom()+" : "+timeToString(partie.getTempsReflexionJ2())+"s");
		System.out.println("******************************************************************");
